...
type Variable struct {
	...
	VariableSource `json:",inline" yaml:",inline"`
}

// VariableSource is the variable kind with it's data.
type VariableSource struct {
	Constant *ConstantVariableSource `json:"constant,omitempty" yaml:"constant,omitempty"`
	Interval *IntervalVariableSource `json:"interval,omitempty" yaml:"interval,omitempty"`
}
...
type Widget struct {
	...
	WidgetSource `json:",inline" yaml:",inline"`
}
...
type Grid struct {
	...
	FixedWidgets bool `json:"fixedWidgets,omitempty" yaml:"fixedWidgets,omitempty"`
...
type GridPos struct {
	...
	W int `json:"w,omitempty" yaml:"w,omitempty"`
...
type WidgetSource struct {
	Singlestat *SinglestatWidgetSource `json:"singlestat,omitempty" yaml:"singlestat,omitempty"`
	Gauge      *GaugeWidgetSource      `json:"gauge,omitempty" yaml:"gauge,omitempty"`
	Graph      *GraphWidgetSource      `json:"graph,omitempty" yaml:"graph,omitempty"`
}

// SinglestatWidgetSource represents a simple value widget.
type SinglestatWidgetSource struct {
	ValueRepresentation `json:",inline" yaml:",inline"`
	Query               Query       `json:"query,omitempty" yaml:"query,omitempty"`
	ValueText           string      `json:"valueText,omitempty" yaml:"valueText,omitempty"`
...
type GaugeWidgetSource struct {
	Query        Query       `json:"query,omitempty" yaml:"query,omitempty"`
	PercentValue bool        `json:"percentValue,omitempty" yaml:"percentValue,omitempty"`
...
type GraphWidgetSource struct {
	...
	Visualization GraphVisualization `json:"visualization,omitempty" yaml:"vizualization,omitempty"`
}
...
type SeriesOverride struct {
	...
	NullPointMode NullPointMode  `json:"nullPointMode,omitempty" yaml:"nullPointMode,omitempty"`
}
...
func (g GridPos) validate(gr Grid) error {
	...
	if gr.FixedWidgets && g.X <= 0 {
		return fmt.Errorf("widget grid position in a fixed grid should have an X position")
	}

	if gr.FixedWidgets && g.Y <= 0 {
		return fmt.Errorf("widget grid position in a fixed grid should have an Y position")
	}
